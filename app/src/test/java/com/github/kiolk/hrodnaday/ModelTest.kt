...
class ModelTest {
    ...
    @Before
    fun setUp(){
        val jsonExample = "{\"day\":1111111111,\"pictureUrl\":\"https://nn.by/img/w630d4/photos/z_2018_02/96958a9f889de0e4e7e2ebe6e7e2e2e1e2e0e0e2e3eae2e2e2e2e2e2-dsxmzo2650949003022018000001-pb1-2-p6r8d.jpg\",\"title\":\"Rocket\",\"description\":\"Small rocket fly\",\"museum\":\"New Castle Museum\"}"
    }
