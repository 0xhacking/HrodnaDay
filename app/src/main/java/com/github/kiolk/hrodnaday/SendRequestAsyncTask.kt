...
class SendRequestAsyncTask : AsyncTask<SendRequest, Void, ResponseModel>(){
    override fun doInBackground(vararg params: SendRequest?): ResponseModel? {
        return params[0]?.perform()
